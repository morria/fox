...
class TestDataHandling:
    ...
    def test_handle_multiple_messages(self, sample_client, mock_client_callback):
        ...
        calls = [call("W1TEST", "First"), call("W1TEST", "Second"), call("W1TEST", "Third")]
...
class TestDisconnection:
    ...
    def test_disconnect_when_already_inactive(
        self, sample_client, mock_agwpe_handler, mock_client_callback
    ):
